...
\firstname{Jan}
\familyname{Papoušek}
\address{Fleischnerova 20}{635 00 Brno}
...
\cvline{}{\textbf{Outline Maps:} Computerized adaptive practice system for learning of geographical facts. The system is currently used by houndreds of users per day and serves as a~platform for online multivariate testing. Based on the collected data we develop new predictive models.\resource{www.slepemapy.cz/en}}
...
\section{Teaching}
\tlcventry[timelinecolor]{2009}{0}{Teaching Assistant}{Faculty of Informatics Masaryk University}{Brno}{}{Java, Algorithm Design II, Introduction to Functional Programming, Introduction to Programing using Python\contact{Botanická 68a, 602 00 Brno, Czech Republic}{+420 549 491 810}{info@fi.muni.cz}{www.fi.muni.cz}}

\section{Working Experience}
\tlcventry[timelinecolor]{2013}{0}{Sofware Engineer}{GoodData}{Brno}{}{Development of a high level analytical language, which is compiled into an intermediate algebraic representation, optimized and then compiled into SQL.\contact{Lidická 965/31, 602 00 Brno, Czech Republic}{}{}{www.gooddata.com}}
...
\section{Other}
\cvline{\textbf{programming}}{Python\advanced, Erlang\advanced, Java\advanced, Bash\familiar, R\familiar}
...
\nocite{aied-impact-of-adaptivity}
